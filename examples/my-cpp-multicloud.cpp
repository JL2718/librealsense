...
int main() try
{
    ...
    GLFWwindow * win = glfwCreateWindow(1920, 1080, "Yeah dude, I rock on a different monitor!", monitors[n_monitors-1], nullptr);
    ...
    while(!glfwWindowShouldClose(win))
    {
        ...
        auto make_pointcloud = [&](double x=0,int y=0,int z=0){
